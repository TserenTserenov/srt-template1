...
└── B.Product/                             # Ядро B: Наша система
    ...
    │   ├── B1.2.Инженер/                  # Структура создателя
...
| B1.2 | Создатель ORA | Инженер | Структура создателя |
| B1.3 | Создатель ORA | Менеджер | Workflow |
| B2.1 | Приложение | Предприниматель | Требования |
| B2.2 | Приложение | Инженер | Архитектура |
| B2.3 | Приложение | Менеджер | Использование |
| B3.1 | Planora | Предприниматель | Миссия |
| B3.2 | Planora | Инженер | ИТ + студия |
| B3.3 | Planora | Менеджер | Процессы |
...
|------|-----------|-------|
| 2026-01-09 | Переход на двухъядерную модель с 19 семействами | Claude |
